...
@implementation PQGameSceneViewController
...
{
    [[CCSpriteFrameCache sharedSpriteFrameCache] addSpriteFramesWithFile:@"GameSprite.plist"];
}
...
{
    //  游戏界面
    [self addSubController:[PQGameHUDViewController controller]];
    // 游戏内容
    [self addSubController:[PQGameViewController controller]];
}
